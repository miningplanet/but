...
// Copyright (c)      2023 mining@planet.ms (miningplanet)
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("65.108.244.156","65.108.244.156");
        ...
        vSeeds.emplace_back("167.86.88.172","167.86.88.172");
        vSeeds.emplace_back("188.34.194.136","188.34.194.136");

        vSeeds.emplace_back("5.161.126.144","5.161.126.144");
        vSeeds.emplace_back("5.161.192.55","5.161.192.55");
        vSeeds.emplace_back("5.161.204.135","5.161.204.135");
        vSeeds.emplace_back("5.161.223.23","5.161.223.23");
        vSeeds.emplace_back("5.161.54.85","5.161.54.85");
        vSeeds.emplace_back("5.161.64.71","5.161.64.71");
        ...
        vSeeds.emplace_back("188.40.212.9","188.40.212.9");
        vSeeds.emplace_back("188.40.212.10","188.40.212.10");
        vSeeds.emplace_back("188.40.212.11","188.40.212.11");
        vSeeds.emplace_back("188.40.212.12","188.40.212.12");
        vSeeds.emplace_back("188.40.212.13","188.40.212.13");
        vSeeds.emplace_back("188.40.212.14","188.40.212.14");
